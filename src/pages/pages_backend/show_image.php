<?php
    ...
    while($data_image = $response_image->fetch_assoc())
    {
      ...
      <div id="starred-image">
          ...
          <i class="save-icon" data-feather="save" data-location='.$old_path.'></i>
          <i class="edit-icon" data-feather="edit-2" data-location='.$old_path.'></i>
          <i class="download-icon" data-feather="download" data-location='.$old_path.'></i>
          <i class="delete-icon" data-feather="trash" data-location='.$old_path.'></i>
        </div>
      </div>';
      echo $div;
    }
